window.SIGHTS_BATCH_B = [
  {
    id: "dagdusheth-halwai-ganpati",
    name: "Shrimant Dagdusheth Halwai Ganpati Mandir",
    mapQuery: "Dagdusheth Halwai Ganpati Mandir, Budhwar Peth, Pune",
    tags: ["Temple", "Modern Architecture"],
    about: "Established in 1893 by sweetmaker Dagdusheth Halwai and his wife Lakshmibai after they lost their only son to a plague epidemic, this shrine began as a private Ganesha idol installed in grief and devotion at their home. Neighbours drawn to their sincerity turned it into a community celebration, and Lokmanya Tilak's push to make Ganeshotsav a public festival for the freedom struggle amplified its stature. Today it is one of India's richest and most-visited Ganpati temples, run by the Dagdusheth Halwai Sarvajanik Ganpati Trust, which also funds education, healthcare and microfinance for the underprivileged.",
    whatToNotice: "The idol's 9.5 kg gold crown and jewellery worth crores, changed for daily aartis; ornate gold-plated shikhara and hall decor; heavy security with hundreds of guards and CCTV; long queues managed with barricades; elaborate annual festive sets that recreate famous monuments and temples.",
    folklore: "Grief-stricken after losing their son to plague, Dagdusheth and Lakshmibai were counselled by their spiritual guru, Shri Madhavnath Maharaj, to worship Ganesha as their own child. The devotion poured into that idol is said to have made it especially responsive to wishes, and it is popularly called a 'Navsacha Ganpati' — a Ganpati who fulfills vows. Devotees still queue for hours believing prayers made here, especially for children's wellbeing, are answered.",
    image: "images/dagdusheth-halwai-ganpati.jpg",
    credit: "Meghavbafana, Wikimedia Commons, CC BY-SA 3.0"
  },
  {
  ...
  {
    id: "guruji-talim-mandal",
    name: "Guruji Talim Ganpati Mandal (Manacha Tisra Ganpati)",
    mapQuery: "Guruji Talim Mandal, Budhwar Peth, Pune",
    tags: ["Temple", "Manache Ganpati"],
    about: "Founded in 1887 by two families — one Hindu (Bhiku Shinde) and one Muslim (Ustad Nalband) — beside a traditional wrestling gymnasium, or 'talim', in Budhwar Peth, this mandal is Pune's earliest recorded example of interfaith cooperation in public Ganesh worship. It predates Lokmanya Tilak's 1893 Sarvajanik Ganeshotsav by six years, and is honoured today as the Manacha Tisra Ganpati (third of the five ceremonially ranked mandals), a lasting symbol of Hindu-Muslim unity in the city's civic life.",
    whatToNotice: "The site's proximity to the old akhada (wrestling pit) that gave the mandal its name; a deliberately simple, traditional idol rather than lavish decor; the story of joint Hindu-Muslim founding retold every year during festivities; its modest chowk setting compared to nearby grand mandals.",
    folklore: "'Guruji Talim' literally means the wrestling pit of a guruji (instructor). Founded jointly by Hindu and Muslim wrestlers six years before Tilak's public Ganeshotsav movement began, it stood as a rare point of communal harmony during Pune's tense 1893 riots. Even today, the mandal is cited as proof that public Ganesh worship — later swept up in nationalist politics — had genuinely inclusive, cross-community roots from its very start.",
    image: "images/guruji-talim-mandal.jpg",
    credit: "Suraj.patekar, Wikimedia Commons, CC BY-SA 3.0"
  },
  {
    id: "tulshibaug-ganpati",
    name: "Tulshibaug Ganpati (Manacha Chautha Ganpati)",
    mapQuery: "Tulshibaug Ganpati Temple, Tulshibaug, Budhwar Peth, Pune",
    tags: ["Temple", "Manache Ganpati"],
    about: "Established in 1901 within Pune's bustling 18th-century Tulshibaug market — itself founded around 1761 by Peshwa army commander Naro Appaji Khire — this shrine is honoured as the fourth of the city's Manache Ganpati. The surrounding neighbourhood takes its name from the tulsi (holy basil) plants grown here in large numbers during the devastating 1896 plague, when the herb was prized for its ayurvedic medicinal value. The mandal and the market around it remain one of the most crowded, vibrant corners of old Pune.",
    whatToNotice: "The 13-foot idol draped in silver and gold ornaments weighing over 80 kg; the mandal's claim as the first in India to install a fibreglass idol, in 1975; ever-changing annual decoration themes ranging from mythology to social issues; the surrounding Tulshibaug market's stalls of bangles, brassware and clothing.",
    folklore: "Tulsi Baug surrounds a much older Ram-Ganpati-Shankar temple complex built in 1761. When bubonic plague ravaged Pune in 1896, residents planted tulsi across the area in the belief it warded off disease, permanently naming the neighbourhood after the plant. The Ganpati mandal founded here a few years later inherited that association with healing and protection, which locals still invoke during darshan.",
    image: "images/tulshibaug-ganpati.jpg",
    credit: "Smrutikokate, Wikimedia Commons, CC BY-SA 3.0"
  },
  {
  ...
  },
  {
    ...
    tags: ["Temple", "Manache Ganpati", "Ancient Architecture"],
    about: "The fifth and final of Pune's Manache Ganpati, this Ganesh was first installed in 1894 by Lokmanya Bal Gangadhar Tilak's Kesari Trust at the Tilak family's Vinchurkar Wada residence, before shifting in 1905 to Gaikwad Wada — the building that became known as Kesari Wada, named after Kesari, the influential Marathi newspaper Tilak founded to fuel India's freedom movement. Located in Narayan Peth near S. P. College, the wada is a PMC Heritage Grade I site and today also houses the Lokmanya Tilak Museum.",
    whatToNotice: "The historic wada building itself, preserving Tilak's writing desk, letters and personal artefacts alongside old Kesari press machinery; deliberately understated Ganpati decor compared to the city's grander mandals, since the mandal prioritises cultural programmes, lectures and competitions over ornamentation, in keeping with Tilak's original intent.",
    folklore: "Unlike the other four Manache Ganpati known for elaborate jewellery and pandals, Kesariwada keeps festivities modest by design — a direct legacy of Tilak's founding vision for Ganeshotsav as a vehicle for public assembly and nationalist awakening at a time when the British restricted other forms of gathering, not as a display of wealth. Many Punekars consider a Ganeshotsav visit to Kesariwada a way of paying respects to the very origins of the public festival itself.",
    image: "images/kesariwada-ganpati.jpg",
    credit: "DesiBoy101, Wikimedia Commons, CC BY-SA 4.0"
  }
];
